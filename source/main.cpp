...
int main()
{
    ...
    game.crossRoads();
    // music.stop();
    // music.openFromFile("/sount/Exploring.wav");
    // music.setVolume(50);
	// music.play();
/*
...
O scena Cufar - Pe oricare drum ales jucatorului ii ies e in cale un cufar, daca alege sa deschida cufarul va trebui sa primeasca niste obiecte ce vor fi adaugate in inventar, aceste obiecte 
sa fie in functie de ce clasa este playerul.
